;(function() {
    ...
    var Field = Backbone.View.extend({
        ...
        initialize: function(options) {
            ...
            this.model = options.model;
            this.idPrefix = options.idPrefix || '';
            this.change_handler = options.change_handler || {};
        ...
        render: function() {
            ...
            if (this.change_handler){
                $(this.el).change(this.schema.change_handler);
            }
    ...
    editors.Number = editors.Text.extend({
        ...
        onKeyPress: function(event) {
            ...
            var newVal = $(this.el).val() + String.fromCharCode(keyCode);
            if (!this.onlyNumbers(keyCode)) event.preventDefault();

            //var numeric = /^[0-9]*\.?[0-9]*?$/.test(newVal);
            //if (!numeric) event.preventDefault();
        },
        onlyNumbers: function (chr){
